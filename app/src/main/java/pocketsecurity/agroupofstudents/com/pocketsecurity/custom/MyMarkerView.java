...
public class MyMarkerView extends MarkerView {
    ...
    public void refreshContent(Entry e, Highlight highlight) {
        ...
        if (e instanceof CandleEntry) {
            ...
            String temp = Utils.formatNumber(ce.getHigh(), 0, true);
        } else {
            peopleDate date = (peopleDate) e.getData();
            String numPeople = date.getDate() + " Value:" + Utils.formatNumber(e.getY(), 0, true);
            tvContent.setText(numPeople);
        }
